...
// Define an asynchronous thunk for user registration
export const registerUser = createAsyncThunk(
  ...
  async ({ username, password }, { rejectWithValue }) => {
    try {
      ...
      // Make an asynchronous POST request to the user registration endpoint
      ...
      return data; // The data returned from the server on successful registration
    } catch (error) {
...
// Create a user register slice using createSlice
const userRegisterSlice = createSlice({
  name: "userRegister",
  initialState: { loading: false, userInfo: null, error: null },
  reducers: {
    // Reducers for synchronous actions can still be defined here if needed
  },
  extraReducers: (builder) => {
    // Handle the asynchronous action states generated by createAsyncThunk
    builder
